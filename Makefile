...
VERSION_LDFLAGS=-X github.com/kucjac/imposm3.Version=$(BUILD_VERSION)
...
%.pb.go: %.proto
	protoc --proto_path=$(GOPATH)/src:$(GOPATH)/src/github.com/kucjac/imposm3/vendor/github.com/gogo/protobuf/protobuf:. --gogofaster_out=. $^
